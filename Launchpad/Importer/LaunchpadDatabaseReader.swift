...
final class LaunchpadDatabaseReader {
    ...
    static func readOldLaunchpadLayout(currentApps: [AppInfo]) -> [AppGridItem] {
        guard let dbPath = LaunchpadDatabaseReader.getOldLaunchpadDatabasePath() else {
    ...
    private static func parseApps(from db: OpaquePointer?) throws -> [String: LaunchpadDBApp] {
    ...
    private static func parseGroups(from db: OpaquePointer?) throws -> [String: LaunchpadGroup] {
    ...
    private static func parseItems(from db: OpaquePointer?) throws -> [LaunchpadDBItem] {
